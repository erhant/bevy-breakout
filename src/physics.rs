...
use crate::{
    ball::Ball, bricks::Brick, game::CollisionSound, paddle::Paddle, scoreboard::Scoreboard,
};
...
impl Plugin for PhysicsPlugin {
    fn build(&self, app: &mut App) {
        app.add_systems(
            FixedUpdate,
            apply_velocity, // (apply_velocity, check_ball_collisions.after(apply_velocity)
        );
    }
}
